...
export class CandidateService {
    private candidates = new Array<Candidate>(
        ...
        { id: 3, name: "Piqué", note: "++", diploma: "Defender 2019", contract: "CDD" },
        ...
        { id: 6, name: "Denis Suárez", note: "+", diploma: "Midfielder 2019", contract: "CDI" },
        ...
        { id: 18, name: "Jordi Alba", note: "+++", diploma: "Defender 2019", contract: "CDD" },
        { id: 19, name: "Digne", note: "+++", diploma: "Defender 2019", contract: "Stage" },
        { id: 20, name: "Sergi Roberto", note: "+", diploma: "Midfielder 2019", contract: "CDI" },
        ...
        { id: 25, name: "Masip", note: "+", diploma: "Goalkeeper 2019", contract: "CDD" }
    );
